...
<p class="title1Print">Laporan Penjualan <br> <span style="font-size: 10pt"><?= $start;?> s/d <?= $end ?></span></p>
<br>
<table border="0" cellspacing="0" cellpadding="2" align="center" width="1060">
  ...
  <tr class="head1Print"> 
    ...
    <td width="10%" height="2">Kasir</td>
    <td width="10%" height="2">Pelanggan</td>
  ...
  <?php 
    ...
    ?>
      <tr class="line-bottom"> 
        ...
        <td width="10%" valign="top"> 
          <div align="left"><?= $row->customer_name; ?></div>
        </td>
        <td width="10%" valign="top"> 
