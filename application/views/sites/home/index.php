 	...
 	<div class="col-md-12">
 		<div class="box box-default">
		  <div class="box-header with-border">
		    <h3 class="box-title">Ringkasan Penjualan</h3>
		  </div>
		  <div class="box-body">
		    	<div class="chart">
	...
	<div class="col-md-6">
	  	...
	  	<div class="box box-info">
		        ...
		        <table class="table no-margin">
					<thead>
		              ...
		              <tr>
		                ...
		                <td>
		                  <div class="sparkbar" data-color="#00a65a" data-height="20">25.000</div>
		                </td>
		              </tr>
		      		</tbody>
		  		</table>
			...
			<div class="box-footer clearfix">
              <a href="javascript:void(0)" class="btn btn-sm btn-default btn-flat pull-right">Lihat</a>
            </div>
		</div>
	</div>
	<div class="col-md-6">
...
<script src="<?= base_url();?>assets/themes/js/dashboard2.js"></script>